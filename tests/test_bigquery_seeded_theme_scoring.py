...
from news_data.bigquery.gdelt_queries import build_gdelt_seeded_theme_scoring_query
from news_data.bigquery.sql_guardrails import validate_bigquery_sql
from news_data.bigquery.theme_bundles import load_theme_bundles
from news_data.task import bigquery_gdelt_seeded_theme_scoring as task_mod
from news_data.task.bigquery_gdelt_seeded_theme_scoring import (
...
def test_scoring_execution_computes_lift_ranks_and_writes_artifacts(tmp_path: Path) -> None:
    ...
    from news_data.bigquery.theme_classification import CATEGORIES
...
def test_scoring_task_registered_and_bundle_untouched() -> None:
    import trading_platform  # noqa: F401
