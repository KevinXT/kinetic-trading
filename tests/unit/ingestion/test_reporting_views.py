...
from kinetic.ingestion.warehouse.bigquery.reporting import build_views as bv
from kinetic.ingestion.warehouse.bigquery.reporting import views as views_mod
from kinetic.ingestion.warehouse.bigquery.reporting.views import (
    REPORTING_VIEWS,
