...
from news_data.bigquery.gdelt_queries import build_gdelt_seeded_theme_discovery_query
from news_data.bigquery.sql_guardrails import validate_bigquery_sql
from news_data.task import bigquery_gdelt_seeded_theme_discovery as task_mod
from news_data.task.bigquery_gdelt_seeded_theme_discovery import (
...
def test_seeded_task_is_registered() -> None:
    ...
    assert "bigquery_gdelt_seeded_theme_discovery" in TASK_REGISTRY
