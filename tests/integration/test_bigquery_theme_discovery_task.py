...
from kinetic.ingestion.news.gdelt.bigquery.tasks import theme_discovery as task_mod
...
def test_task_is_registered() -> None:
    ...
    assert "news.gdelt.bigquery.discover_themes" in registry.task_ids()
...
from kinetic.ingestion.news.gdelt.bigquery.queries import (  # noqa: E402
    QUERY_BUILDER_VERSION,
    build_gdelt_theme_discovery_query,
)
from kinetic.ingestion.warehouse.bigquery.cache import (  # noqa: E402
    bigquery_cache_path,
    build_cache_key,
    load_cached_rows,
    write_cached_rows,
