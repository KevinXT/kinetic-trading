...
- Blind article relevance annotation
- Blind duplicate-pair review
- Adjudication without overwriting raw labels
- Deterministic JSONL export into ignored local paths
