...
from kinetic.data.catalog.entities import SEMICONDUCTOR_FIXTURE_VERSION, load_entity_references
...
from kinetic.ml.relevance.content_controls import is_git_tracked_research_path
...
from kinetic.ml.relevance.schemas import RELEVANCE_LABELS
...
class ReproducibilityRecord:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "cli_equivalent": (f"kinetic run {self.config_path} --run-id {self.run_id}"),
        }
    ...
    def run_preflight(
        ...
        *,
        ...
        if RunContext is None:
            raise RuntimeError("kinetic.core is required to run preflight")
