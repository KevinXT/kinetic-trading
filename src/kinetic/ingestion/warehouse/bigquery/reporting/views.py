...
def _positive_int(value: object, *, field: str) -> int:
    # `value` comes straight from YAML, so it can be anything. int() rejects the
    # types it cannot convert; that TypeError is the validation.
    try:
        out: int = int(value)  # type: ignore[call-overload]
