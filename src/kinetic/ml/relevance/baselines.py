...
from kinetic.data.catalog.seeds import DEFAULT_SEMICONDUCTOR_SEEDS, INDUSTRY_PHRASE
from kinetic.data.schemas.entities import EntityReferenceV1
from kinetic.data.schemas.news import ArticleTextRecordV1
from kinetic.processing.news.entity_linking import EntityMatchV1, match_entities
