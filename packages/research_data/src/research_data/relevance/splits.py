...
from news_data.dedupe.exact import ExactDuplicateCluster, cluster_index
from news_data.dedupe.near import NearDuplicateCandidate

from research_data.relevance.models import AdjudicatedAnnotationV1
from research_data.relevance.sampling import BenchmarkCandidate
